  ...
  <div class="glass-card">
    <div class="p-6">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 items-end">
        <div>
          <label for="symbolFilter" class="block text-sm font-semibold mb-2 text-gray-400"
            >Símbolo</label
          >
          <select
            id="symbolFilter"
        ...
        <div>
          <label for="startDate" class="block text-sm font-semibold mb-2 text-gray-400"
            >Data Início</label
          >
          <input
            id="startDate"
        ...
        <div>
          <label for="endDate" class="block text-sm font-semibold mb-2 text-gray-400"
            >Data Fim</label
          >
          <input
            id="endDate"
        ...
        <div>
          ...
          <div class="flex gap-2">
            ...
            <button
              class="px-4 py-2 border border-gray-600 text-gray-300 hover:bg-gray-800 rounded-lg transition-colors"
              @click="resetFilters"
            >
              Limpar
            </button>
