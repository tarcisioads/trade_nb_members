<template>
  <div class="container mx-auto px-4 py-8">
    <div
      v-if="errorMessage"
      class="bg-red-500/10 border border-red-500/50 text-red-200 px-4 py-3 rounded mb-6 flex justify-between items-center animate-fade-in"
      role="alert"
    >
    ...
    <div class="max-w-2xl mx-auto glass-card animate-slide-up">
      <div class="p-6 border-b border-white/10">
        <h5 class="text-xl font-bold text-white mb-0">
          {{ isEditing ? 'Edit Position History' : 'Add New Position History' }}
        </h5>
      </div>
      <div class="p-6">
        <form class="space-y-6" @submit.prevent="savePositionHistory">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label class="block text-sm font-medium text-gray-400 mb-2">Symbol</label>
              <input
                v-model="positionHistoryData.symbol"
                type="text"
            ...
            <div>
              ...
              <input
                v-model="positionHistoryData.positionId"
                type="text"
                class="w-full bg-gray-900/50 border border-gray-700 rounded-lg px-4 py-2.5 text-white focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all outline-none"
                required
              />
            ...
            <div>
              ...
              <select
                v-model="positionHistoryData.positionSide"
            ...
            <div class="md:col-span-2">
              <div class="flex gap-6 p-4 bg-gray-800/30 rounded-xl border border-white/5">
                <div class="flex items-center gap-3">
                  <input
                    id="isolatedCheck"
                    v-model="positionHistoryData.isolated"
                    type="checkbox"
                    class="w-5 h-5 rounded border-gray-600 bg-gray-700 text-blue-600 focus:ring-blue-500/50 focus:ring-offset-0"
                  />
                  <label class="text-gray-300 cursor-pointer select-none" for="isolatedCheck"
                    >Isolated</label
                  >
                </div>
                <div class="flex items-center gap-3">
                  <input
                    id="closeAllPositionsCheck"
                    v-model="positionHistoryData.closeAllPositions"
                    type="checkbox"
                    class="w-5 h-5 rounded border-gray-600 bg-gray-700 text-blue-600 focus:ring-blue-500/50 focus:ring-offset-0"
                  />
                  <label
                    class="text-gray-300 cursor-pointer select-none"
                    for="closeAllPositionsCheck"
                    >Close All Positions</label
                  >
                </div>
              </div>
            </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                v-model="positionHistoryData.positionAmt"
                type="text"
            ...
            <div>
              <label class="block text-sm font-medium text-gray-400 mb-2"
                >Close Position Amount</label
              >
              <input
                v-model="positionHistoryData.closePositionAmt"
                type="text"
                class="w-full bg-gray-900/50 border border-gray-700 rounded-lg px-4 py-2.5 text-white focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all outline-none font-mono"
                required
              />
            ...
            <div>
              ...
              <input
                v-model="positionHistoryData.realisedProfit"
                type="text"
                class="w-full bg-gray-900/50 border border-gray-700 rounded-lg px-4 py-2.5 text-white focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all outline-none font-mono"
                required
              />
            ...
            <div>
              ...
              <input
                v-model="positionHistoryData.netProfit"
                type="text"
                class="w-full bg-gray-900/50 border border-gray-700 rounded-lg px-4 py-2.5 text-white focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all outline-none font-mono"
                required
              />
            ...
            <div>
              <label class="block text-sm font-medium text-gray-400 mb-2"
                >Average Close Price</label
              >
              <input
                v-model.number="positionHistoryData.avgClosePrice"
                type="number"
                step="any"
                class="w-full bg-gray-900/50 border border-gray-700 rounded-lg px-4 py-2.5 text-white focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all outline-none font-mono"
                required
            ...
            <div>
              ...
              <input
                v-model="positionHistoryData.avgPrice"
                type="text"
                class="w-full bg-gray-900/50 border border-gray-700 rounded-lg px-4 py-2.5 text-white focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all outline-none font-mono"
                required
              />
            ...
            <div>
              ...
              <input
                v-model.number="positionHistoryData.leverage"
                type="number"
                step="any"
                class="w-full bg-gray-900/50 border border-gray-700 rounded-lg px-4 py-2.5 text-white focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all outline-none font-mono"
                required
            ...
            <div>
              <label class="block text-sm font-medium text-gray-400 mb-2"
                >Position Commission</label
              >
              <input
                v-model="positionHistoryData.positionCommission"
                type="text"
                class="w-full bg-gray-900/50 border border-gray-700 rounded-lg px-4 py-2.5 text-white focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all outline-none font-mono"
                required
              />
            ...
            <div>
              ...
              <input
                v-model="positionHistoryData.totalFunding"
                type="text"
                class="w-full bg-gray-900/50 border border-gray-700 rounded-lg px-4 py-2.5 text-white focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all outline-none font-mono"
                required
              />
          ...
          <div class="border-t border-white/10 pt-6 mt-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                ...
                <input
                  v-model.number="positionHistoryData.openTime"
                  type="number"
                  class="w-full bg-gray-900/50 border border-gray-700 rounded-lg px-4 py-2.5 text-white focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all outline-none font-mono"
                  required
                />
              ...
              <div>
                ...
                <input
                  v-model.number="positionHistoryData.updateTime"
                  type="number"
                  class="w-full bg-gray-900/50 border border-gray-700 rounded-lg px-4 py-2.5 text-white focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all outline-none font-mono"
                  required
                />
              ...
              <div>
                ...
                <input
                  v-model.number="positionHistoryData.closeTime"
                  type="number"
                  class="w-full bg-gray-900/50 border border-gray-700 rounded-lg px-4 py-2.5 text-white focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all outline-none font-mono"
                  required
                />
          ...
          <div class="flex justify-end gap-4 pt-4 border-t border-white/10">
            <router-link
              to="/dashboard"
              class="px-6 py-2.5 border border-gray-600 text-gray-300 rounded-lg hover:bg-gray-700/50 transition-all"
              >Cancel</router-link
            >
...
onMounted(async () => {
  if (isEditing.value) {
    try {
      ...
      errorMessage.value =
        error instanceof Error ? error.message : 'Failed to load position history';
    }
  }
});
...
const savePositionHistory = async () => {
  try {
    ...
    const url = isEditing.value
      ? `/api/position-history/${route.params.id}`
